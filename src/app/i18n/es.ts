export const es = {
  ...
  prediction: {
    ...
    draw: 'Empate',
    win: 'Gana {{ team }}',
    advancerTitle: 'Si hay empate, ¿quién avanza en los penales?',
    advancerHint:
      'Los partidos de eliminación no pueden terminar en empate. Elige quién gana la tanda para un bono de +3.',
    advancerRequired: 'Elige qué equipo avanza en los penales.',
    cancel: 'Cancelar',
  ...
  howto: {
    ...
    scoreAdvancer: 'Equipo correcto que avanza en penales (eliminación)',
