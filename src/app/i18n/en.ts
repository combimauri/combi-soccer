export const en = {
  ...
  prediction: {
    ...
    draw: 'Draw',
    win: '{{ team }} win',
    advancerTitle: 'If tied, who advances on penalties?',
    advancerHint:
      "Knockout matches can't end in a draw. Pick the shoot-out winner for a +3 bonus.",
    advancerRequired: 'Pick which team advances on penalties.',
    cancel: 'Cancel',
  ...
  howto: {
    ...
    scoreAdvancer: 'Right team to advance on penalties (knockouts)',
