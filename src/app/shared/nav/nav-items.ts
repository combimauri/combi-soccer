...
export interface NavItem {
  path: string;
  /** Transloco key for the full label (desktop bar). */
  labelKey: string;
  /** Optional shorter label for the cramped mobile tab bar; falls back to `labelKey`. */
...
export const NAV_ITEMS: readonly NavItem[] = [
  {
    path: '/',
    labelKey: 'nav.predictNow',
    shortLabelKey: 'nav.predictNowShort',
    icon: 'predict',
    exact: true,
  },
  {
    ...
    shortLabelKey: 'nav.matchesShort',
    icon: 'matches',
  },
